      ...
      <main className="flex flex-col items-center justify-center min-h-screen p-6 bg-gray-950 text-gray-100">
        <div className="w-full max-w-2xl text-center space-y-8">
          <header className="space-y-2">
            ...
            <p className="text-gray-4.00">Interface Hub Multi-outils</p>
          </header>

          <section
            className="w-full py-4"
            aria-label="Section de test Supabase"
          >
          ...
          <footer className="text-xs text-gray-600">
            Hub de développement • Prêt pour l'intégration du Header Retro /
            Cute
          </footer>
        </div>
      </main>
